      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 text-left">
            <a
              href="#"
              className="text-lg sm:text-l font-bold text-foreground/80 relative font-dancing hover:text-foreground transition-colors duration-200 truncate max-w-[120px] sm:max-w-none"
            >
              Rinku Diwakar
            </a>
            <a
              href="mailto:diwakar.active@gmail.com"
              className="bg-[#fffcef] px-2 sm:px-3 py-1 rounded-full border border-[#fff6d3] inline-flex items-center cursor-pointer hover:bg-[#fffcd9] text-xs sm:text-sm"
            >
              <svg
                className="w-3 sm:w-3.5 mr-1 sm:mr-2 fill-[#625833]"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z" />
              </svg>
              <span className="hidden sm:inline lg:block">diwakar.active@gmail.com</span>
